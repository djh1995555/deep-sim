...
`R000-R033` are complete and were run under the `deep-sim` Miniforge environment. The project is ready to proceed to `M7: R034-R036`, which should run cross-vehicle/config generalization using the selected scaffold configuration and baselines.
