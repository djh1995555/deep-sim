...
DEFAULT_DEBUG_PANELS: Dict[str, Sequence[str]] = {
    ...
    "Friction Usage": (
        "vehicle.friction_usage_fl",
        "vehicle.friction_usage_fr",
        "vehicle.friction_usage_rl",
        "vehicle.friction_usage_rr",
    ),
    "Reference": (
        "input.reference.x_m",
